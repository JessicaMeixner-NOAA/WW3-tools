...
def main():
  ...
  INPUTDIR=f"/work2/noaa/marine/ming.chen/GFS_Retro_Data/data/outinterp/{model}"
  ...
  for k in range(len(season)):
    if season[k] == "stream1a":
       startdate = dt.datetime(2022,8,31) #30 12z 
       enddate = dt.datetime(2022,10,15)
    elif season[k] == "stream1b":
       startdate = dt.datetime(2024,3,1)
       enddate = dt.datetime(2024,5,11) #0531
    elif season[k] == "stream2":
       startdate = dt.datetime(2024,6,1)
       enddate = dt.datetime(2024,8,4) #1130
    elif season[k] == "stream3":
       startdate = dt.datetime(2024,12,1)
       enddate = dt.datetime(2025,2,16) #5 31
    elif season[k] == "stream4":
       startdate = dt.datetime(2025,6,1)
       enddate = dt.datetime(2025,11,30)
    elif season[k] == "realtime":
       startdate = dt.datetime(2025,11,20)
       enddate = dt.datetime(2025,2,28)
