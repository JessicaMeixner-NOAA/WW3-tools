...
for k in range(len(season)):
   ...
   for i in range(len(dates1)):
            outfile = os.path.join(rootdir, f"job_{model}_{season[k]}_{dates1[i]}.sh")
...
#SBATCH -t 08:00:00
#SBATCH -A marine-cpu
#SBATCH -J procsat_{model}_{season[k]}_{dates1[i]}
#SBATCH -o run_{model}_{season[k]}_{dates1[i]}.o%j
...
"""
                ...
                if model == "HR1":  
                  ...
                  f.write('MODEL_DATA_DIR="/work/noaa/marine/jmeixner/Data/${MODEL}/${SEASON}/gfs.${DATE}/${TZ}/products/wave/gridded" \n')
